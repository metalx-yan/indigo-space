    ...
    <div class="site-wrap">
        ...
        <div class="site-section bg-light" id="lowongan-kerja">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-7">
                        <h2 class="heading">List Events</h2>
            ...
            @elseif($jobvacancy->end->format('Y-m-d') != Carbon\Carbon::now()->format('Y-m-d')) --}}
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="service h-100">
                                ...
                                <p><span class=""><img src="{{ asset('images/event.png') }}" height="20%"
                                            width="30%" alt=""></span></p>
                                <center><h3>{{ ucwords($evt->name) }}</h3></center>
                                <hr>
                                <p>Tanggal    : {{ $evt->tanggal }}</p>
                                <p>Narasumber : {{ $evt->narasumber }}</p>
                                <p>Deskripsi  : {{ $evt->deskripsi }}</p>

                                <a href="{{ $evt->link }}" class="btn btn-primary btn-sm">Link Zoom</a>
        ...
        <div class="author  d-lg-flex" id="about-section">
            <div class="bg-img" style="background-image: url('http://www.prospera-perwira.com/img/about-img.jpg');">
            </div>
            <div class="text">
                <h3>Profile Prospera</h3>
                <p>PT. Anugrah Distributor Indonesia adalah perusahaan yang memberikan solusi di bidang care car dan cat
                    semprot.</p>
                            ...
                            <div class="d-flex align-items-center vcard">
                                <figure class="mb-0 mr-3">
                                    <img src="{{ asset('images/person_3.jpg') }}"
                                        alt="Free website template by Free-Template.co" class="img-fluid ounded-circle">
                                </figure>
